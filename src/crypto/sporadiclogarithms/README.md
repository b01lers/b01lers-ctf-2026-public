# __sporadiclogarithms__ by __cyberg__         
## Directory Structure         
```         
sporadiclogarithms         
 ├── deploy             
...
```bash
git switch -c sporadiclogarithms_cyberg
```
### sporadiclogarithms/deploy
