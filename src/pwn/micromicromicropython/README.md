# __micromicromicropython__ by __oh_word__         
## Directory Structure         
```         
...
```bash
git switch -c micromicromicropython_oh_word
```
### micromicromicropython/deploy
