# __build-a-builtin__ by __oh_word__         
## Directory Structure         
```         
build-a-builtin         
 ├── deploy             
...
```bash
git switch -c build-a-builtin_oh_word
```
### build-a-builtin/deploy
